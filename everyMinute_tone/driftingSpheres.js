...
function init() {
	...
	for ( var i = 0; i < 5; i ++ ) {
		...
		mesh.position.x = i * ( 2.0 * Math.random() - 1.0 );
		mesh.position.y = i* ( 2.0 * Math.random() - 1.0 );
	...
	var col = new THREE.Color("rgb(93,17,59)");
	var dirLight = new THREE.DirectionalLight( col, 0.5 );
